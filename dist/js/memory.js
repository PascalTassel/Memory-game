...
var Datas = /*#__PURE__*/function () {
   ...
   */
  function Datas(backupMethod, rankingLimit, settings) {
    ...
    this.rankingLimit = rankingLimit; // Set datas settings
...
/* harmony import */ var _datas_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./datas.js */ "./js/datas.js");
/* harmony import */ var _progress_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./progress.js */ "./js/progress.js");
...
var Memory = /*#__PURE__*/function () {
  ...
  function Memory() {
    ...
    fetch('settings.json').then(function (response) {
      ...
      _this.cards = []; // Current selected cards

      _this.selectedCards = []; // Flipped cards

      _this.flippedCards = []; // Game status
      ...
      _this.counter = new _counter_js__WEBPACK_IMPORTED_MODULE_2__["default"](_this.duration); // Datas instance

      _this.datas = new _datas_js__WEBPACK_IMPORTED_MODULE_3__["default"](_this.backupMethod, _this.rankingLimit, data.database); // Alert instance
  ...
  _createClass(Memory, [{
    ...
    value: function gameOver() {
      ...
      this.counter.stop(); // If player loose, display loose alert
